  ...
  return (
    ...
    >
      ...
      <SidebarFooter className="border-t border-slate-100">
        <SidebarMenu>
          <SidebarMenuItem>
            <div className="flex items-center justify-between w-full rounded-xl bg-slate-50 group-data-[collapsible=icon]:bg-transparent group-data-[collapsible=icon]:p-0">
              <div className="flex items-center gap-2 overflow-hidden">
                ...
                >
                  ...
                  ${isPending ? "bg-slate-200 animate-pulse" : "text-[#FFDBFD] bg-[#6367FF]"}`}
                    >
                      {!isPending &&
